...
class Demo
{
	...
	public static void main(String [] args)
	{
		...
		Gadget[] g1={new Gadget("Laptop","Dell",90000.00f),new Gadget("Mobile","Samsung",25000)};
		Gadget[] g2={new Gadget("Laptop","Lenovo",60000.00f),new Gadget("Mobile","Realme",18000)};
		Emp e1=new Emp("Pankaj",45000.0f,g1);
		Emp e2=new Emp("Sudha",62000.0f,g2);
		e1.displayEmpInfo();
		e2.displayEmpInfo(); 
